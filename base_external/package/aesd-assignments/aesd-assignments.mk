...
AESD_ASSIGNMENTS_GIT_SUBMODULES = YES
 ...
 # Buildroot n’installe que ce que tu déclares explicitement dans AESD_ASSIGNMENTS_INSTALL_TARGET_CMDS
...
define AESD_ASSIGNMENTS_INSTALL_TARGET_CMDS
    ...
    #NEW 
    #$(INSTALL) -m 0755 $(@D)/assignment-autotest/test/assignment4/finder-test.sh $(TARGET_DIR)/usr/bin/
